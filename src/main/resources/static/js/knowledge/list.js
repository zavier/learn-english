$(document).ready(function () {
    ...
    $('#knowledgeData').bootstrapTable({
        ...
        url: '/le/knowledge/list-user-create',
        method: 'post',
        cache: false,
        uniqueId: 'id',
        pagination: true,
...
$("#updateKnowledgeForm").validate({
    ...
    submitHandler: function () {
        ...
        var url = '/le/knowledge/update-knowledge';
...
function deleteKnowledgeConfirm(id) {
    $.confirm({
        ...
        buttons: {
            确定: function () {
                $.get('/le/knowledge/delete-knowledge/' + id, function (data) {
...
$("#addKnowledgeForm").validate({
    ...
    submitHandler: function () {
        ...
        var url = '/le/knowledge/save-knowledge';
        var params = getAjaxJsonParamObject(url, 'POST', data);
